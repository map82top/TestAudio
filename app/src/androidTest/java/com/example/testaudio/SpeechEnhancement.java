...
//
//    public SpeechEnhancement(Context context, String tflitePath) throws IOException {
...
//    }
//
////    val doubleData = shortArrayToDoubleArray(chunkShortArray)
////    var chuckShortBuffer = ShortBuffer.allocate(chunkShortArray.size)
////    var maxIteration = (chunkShortArray.size) / 256
////                    for (i in 0..maxIteration) {
////        var maxValue = (i + 1) * 256
////        if (maxValue > chunkShortArray.size) {
////            maxValue = chunkShortArray.size - 1
////        }
////        val sliceRange = IntRange(i * 256, maxValue)
////        val sliceArray = doubleData?.sliceArray(sliceRange)
////        var seDoubleResult = speechEnhancement!!.audioSE(sliceArray)
////        if (sliceArray!!.size < 256) {
////            seDoubleResult = seDoubleResult.sliceArray(IntRange(0, sliceArray.size - 1))
////        }
////        val seShortResult = doubleArrayToShortArray(seDoubleResult)
////        chuckShortBuffer.put(seShortResult)
//
////    private fun shortArrayToDoubleArray(shortData: ShortArray): DoubleArray? {
...
////    }
////
////    private fun doubleArrayToShortArray(doubleArray: DoubleArray): ShortArray? {
////        val shortArray = ShortArray(doubleArray.size)
////        for (i in doubleArray.indices) {
////            shortArray[i] = (doubleArray[i] * 32768.0).toInt().toShort()
////        }
////        return shortArray
////    }
//
...
////            .build()
//
//    //                    audioTrack.write(chunkByteArray, 0, chunkLen)
////                    audioTrack.play()
//}
